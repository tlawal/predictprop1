      ...
      <div className="flex">
        ...
        <div className="lg:hidden mb-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-800/50 backdrop-blur-sm border border-slate-600 rounded-lg text-white hover:bg-slate-700/50 transition-colors"
          >
        ...
        {filteredMarkets.length > 0 && (
          ...
          onToggleFilters={() => setFiltersModalOpen(true)}
          />
        )}
        </div>
      </div>
