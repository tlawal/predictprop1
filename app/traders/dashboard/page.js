...
function TradersPageContent() {
  ...
  const handleTabChange = (index) => {
    ...
    router.replace(`/traders/dashboard?tab=${tabNames[index]}`, { scroll: false });
  };
  ...
  const handleViewPositions = () => {
    ...
    router.replace('/traders/dashboard?tab=positions', { scroll: false });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20 md:pt-0">
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Header Card */}
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 mx-4 mt-4 mb-6">
